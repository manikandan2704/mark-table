function getReport(){
    ...
    var tamilMarks = document.getElementById('txtTamil').value;
    var mathsMarks = document.getElementById('txtMaths').value;
    var scienceMarks = document.getElementById('txtScience').value;
    var socialMarks = document.getElementById('txtSocial').value;
    
    //calculate the total marks (using double notation technique)
     var totalMarks = parseInt(engMarks) + parseInt( tamilMarks) +parseInt ( mathsMarks) + parseInt( scienceMarks)+parseInt(socialMarks);
